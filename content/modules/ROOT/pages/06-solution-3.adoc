...
.. Login using {openshift_cluster_admin_username} as the username and {openshift_cluster_admin_password} as the password. Allow selected permissions and proceed.
