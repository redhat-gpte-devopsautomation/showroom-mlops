...
object-detection-yolov5 -> Open. This will open the workbench in another tab and log in as `{openshift_cluster_admin_username}` with the password `{openshift_cluster_admin_password}`
