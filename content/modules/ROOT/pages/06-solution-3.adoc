...
and login to the cluster as user1. (get the oc login credentials from openshift console for user1)

Clone the repository which we need to run to create our workbench with S3 storage and model serving deployed.
This is the repository to be cloned - https://github.com/ritzshah/object-detection-model-serving-yolov5.git
