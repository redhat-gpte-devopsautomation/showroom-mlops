...
* If you already have the previous notebook server running, go to Hub Control Panel and Stop the same as shown below.
image:hub-control-1.png[Hub Control Panel]
image:stop-notebook-server.png[Stop Notebook Server]

Once you stop the notebook server, you should switch over to terminal and login to the cluster.
...
* The Red Hat OpenShift AI Dashboard will be empty as we
