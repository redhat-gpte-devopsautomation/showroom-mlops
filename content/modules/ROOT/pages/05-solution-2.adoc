...
.... *Globex Review Simulator URL:* hhttps://reviews-simulator-sentiment-analysis.{openshift_cluster_ingress_domain}[window=_blank]
Go to your Globex review simulator to introduce multiple comments simultaneously as shown in the below image as POST, select clothing catalogue, then `Try ii out` and Execute.
