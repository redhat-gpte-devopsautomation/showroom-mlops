...
... Ensure that you execute the above step twice to generate 50 comments for clothing category.This is what you see after Execution of the POST is successful.
