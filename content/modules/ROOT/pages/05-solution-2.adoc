...
... Ensure that you execute the above step 4 to 5 times to generate enough comments for clothing category.This is what you see after Execution of the POST is successful.
