...
information here:
+
image:gittea-url.png[instructions/gittea-url]
...
All Cells*
** image:csv-restart-run-all.png[instructions/csv-restart-run-all]
...
image:select-administrator.png[instructions/select-administrator]
. Navigate to *Pipelines* , then *Pipelines* (yes, again), and then go
to *PipelineRuns*
image:select-pipelines.png[instructions/select-pipelines]
...
image:commit-msg.png[instructions/commit-msg]
