...
You go to your topology view as a developer and ensure that you are selecting sentiment-analysis project. If you review carefullly, you can see that all the aiml services and the persist review service are all running using knative serverless functionality.
